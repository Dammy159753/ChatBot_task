...
class ItemStore(object):
    ...
    def __init__(self, ccb_model, ccb_config):
        from rasa_nlu.model import Interpreter
        self.interpreter = Interpreter.load(ccb_model)
        self._items = {}    
...
if __name__ == '__main__':
    ccb_model = "projects/ccb_chatbot/ccb_chatbot_demo"
    #chat_detection_model = "models/ivr/demo_chat_detection"
    ccb_config = "ccb_chatbot_config.yml"
    ...
    store = ItemStore(ccb_model, ccb_config)
    store.app.run('10.1.58.21', 5000)
